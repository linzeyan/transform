...
mod tests {
    ...
    #[test]
    fn json_to_proto_generates_fields() {
        let proto = json_to_proto(r#"{"id":1,"name":"Ada"}"#).unwrap();
    ...
    #[test]
    fn proto_back_to_json() {
        let src = "message AutoGenerated {\n  string name = 1;\n  int32 id = 2;\n}";
        let json = proto_to_json(src).unwrap();
