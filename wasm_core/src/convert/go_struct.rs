...
/// Generates a Go `struct` definition that mirrors the shape of the provided JSON value.
///
/// Field names are title-cased, deduplicated, and annotated with `json` tags to
